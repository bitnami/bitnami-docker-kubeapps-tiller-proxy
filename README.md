...
* [`1-scratch`, `1.8.1-scratch-r1`, `1`, `1.8.1`, `1.8.1-r1`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-tiller-proxy/blob/1.8.1/1/scratch/Dockerfile)
