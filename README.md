...
* [`1-scratch`, `1.6.0-scratch-r0`, `1`, `1.6.0`, `1.6.0-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-tiller-proxy/blob/1.6.0/1/scratch/Dockerfile)
