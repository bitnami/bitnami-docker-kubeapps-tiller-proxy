...
* [`1-scratch`, `1.4.1-scratch-r0`, `1`, `1.4.1`, `1.4.1-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-tiller-proxy/blob/1.4.1/1/scratch/Dockerfile)
