...
* [`1`, `1-scratch`, `1.11.1`, `1.11.1-scratch-r0`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-tiller-proxy/blob/1.11.1-scratch-r0/1/scratch/Dockerfile)
