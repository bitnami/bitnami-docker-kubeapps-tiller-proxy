...
* [`1-scratch`, `1.8.1-scratch-r2`, `1`, `1.8.1`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/bitnami-docker-kubeapps-tiller-proxy/blob/1.8.1/1/scratch/Dockerfile)
